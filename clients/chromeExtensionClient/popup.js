...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const useSrtCheckbox = document.getElementById("useSrtCheckbox"); // Added for SRT checkbox
  ...
  useSrtCheckbox.addEventListener("change", () => {
    const useSrtState = useSrtCheckbox.checked;
    chrome.storage.local.set({ useSrtState });
  });
  ...
  async function startCapture() {
    ...
    const useSrt = useSrtCheckbox.checked; // Include SRT option
    ...
    chrome.runtime.sendMessage(
      { 
        ...
        useSrt: useSrt // Include SRT option
      }, () => {
