...
class WhisperModel:
    def __init__(
        ...
        if os.path.isdir(model_size_or_path):
            logging.info(f"Using local model: {model_size_or_path}")
            model_path = model_size_or_path
        else:
            logging.info(f"Downloading model: {model_size_or_path}")
        ...
        if os.path.isfile(tokenizer_file):
            logging.info(f"Loading tokenizer: {tokenizer_file}")
            self.hf_tokenizer = tokenizers.Tokenizer.from_file(tokenizer_file)
        else:
            logging.info(f"Downloading tokenizer: {model_size_or_path}")
